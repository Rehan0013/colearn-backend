...
<body style="margin:0;padding:0;background-color:#f4f6fb;font-family:'Segoe UI',Tahoma,Geneva,Verdana,sans-serif;">
    <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f4f6fb;padding:40px 0;">
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,0.08);">
                    ...
                    <tr>
                        <td style="background:linear-gradient(135deg,#f59e0b 0%,#d97706 100%);padding:40px 48px;text-align:center;">
                            <h1 style="margin:0;color:#ffffff;font-size:28px;font-weight:700;letter-spacing:-0.5px;">Colearn</h1>
                            <p style="margin:8px 0 0;color:rgba(255,255,255,0.8);font-size:14px;letter-spacing:1px;text-transform:uppercase;">Milestone Achieved</p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:48px;">
                            <h2 style="margin:0 0 16px;color:#1e1b4b;font-size:24px;font-weight:600;">You're on Fire, ${firstName}! 🔥</h2>
                            <p style="margin:0 0 32px;color:#4b5563;font-size:15px;line-height:1.7;">
                                Unbelievable! You've just hit a <strong>${streak}-day study streak</strong>. Your dedication to learning is truly inspiring. Keep that momentum going!
                            </p>

                            <!-- Streak Badge -->
                            <table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:32px;">
                                <tr>
                                    <td align="center" style="background:#fff7ed;border:2px solid #fdba74;border-radius:100px;padding:24px;width:120px;height:120px;">
                                        <p style="margin:0;color:#ea580c;font-size:48px;font-weight:800;">${streak}</p>
                                        <p style="margin:0;color:#9a3412;font-size:12px;font-weight:600;text-transform:uppercase;">Days</p>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <!-- Footer -->
                    <tr>
                        <td style="padding:24px 48px;text-align:center;background-color:#f9fafb;">
                            <p style="margin:0;color:#9ca3af;font-size:13px;">Keep up the great work!</p>
                            <p style="margin:4px 0 0;color:#d1d5db;font-size:12px;">© ${new Date().getFullYear()} Colearn. All rights reserved.</p>
                        </td>
                    </tr>
        ...
        await sendEmail(email, `${streak} Days! You're unstoppable! 🔥`, `Congrats on your ${streak}-day streak!`, template);
    });
}
