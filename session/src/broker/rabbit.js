...
export const connectRabbitMQ = async (onConnect) => {
    ...
    try {
        ...
        connection.on("close", () => {
            console.warn("Session service: RabbitMQ connection closed. Retrying...");
            reconnect();
        });
        ...
        channel.on("close", () => {
            console.warn("Session service: RabbitMQ channel closed.");
        });

        console.log("Session service: RabbitMQ connected successfully");
